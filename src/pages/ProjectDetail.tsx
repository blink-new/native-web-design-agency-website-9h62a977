              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="bg-secondary-50 rounded-lg p-6">
                    ...
                    <p className="text-secondary-700 mb-1">Completed in {project.year}</p>
                  </div>
                </div>
                ...
                <div className="bg-primary-50 rounded-lg p-6 mb-6">
                  ...
                  <p className="text-secondary-700 mb-4">
                    Experience this project's interface firsthand with our interactive demo.
                  </p>
                  <Button asChild>
                    <Link to={
                      ...
                      project.id === 5 ? "/mockups/sustainability-dashboard" :
                      project.id === 6 ? "/mockups/meditation-app" :
                      project.id === 7 ? "/mockups/training-platform" :
                      project.id === 8 ? "/mockups/design-system" :
                      project.id === 11 ? "/mockups/saas-landing" :
                      project.id === 12 ? "/mockups/hotel-website" :
                      project.id === 13 ? "/mockups/portfolio-resume" : "#"
                    }>
